...
function onSerach(){
	...
	if(process=='B') step='';
	Web.util.load("datagrid1",{stu_level:stu_level,stu_name:stu_name,s_date:s_date,e_date:e_date,isstudent:isstudent,groupname:groupname,followor:follow,process:process,step:step});
}
