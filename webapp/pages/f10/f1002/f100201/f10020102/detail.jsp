          ...
          <colgroup align="right" width="25%"></colgroup>
           <colgroup align="left" width="25%"></colgroup>
                <tr>
                    <td >部门名称:</td>
                    <td>
                       <input id="groupname" name="groupname"  class="mini-textbox" enabled="false" /> <font color="red">*</font>
                       <input id="stuid" name="stuid" class="mini-textbox" enabled="false" visible="false" />
                ...
                <tr>
                    ...
                    <td >毕业时间：</td>
                    <td >
                     <input id="graduatetime" name="graduatetime" class="mini-datepicker" format="yyyyMMdd"  /> 
                    </td>
                </tr>
                <tr>
                	<td >毕业证号：</td>
...
var grouptype='${sessionScope["com.wb.session.grouptypeclass"] }';
loadForm();
function loadForm() {
  //加载表单数据
   var url = '<%=request.getContextPath()%>/work/f10020102/queryStudentRemoteBystuid.action?stuid='+stuid;
...
function submitForm() {
	...
	//提交表单数据
	var url = '<%=request.getContextPath()%>/work/f10020102/execStudentRemoteUpdate.action';
