...
<body>
          ...
          <colgroup align="right" width="15%"></colgroup>
           ...
           <colgroup align="left" width="15%"></colgroup>
                ...
                <tr>
                    ...
                    <td>
                          <input id="loginname" name="loginname" class="mini-textbox" onvalidation="onEnglishAndNumberValidation" vtype="maxLength:50" required="true"/> 
                    </td>
                </tr>
                <tr>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:280px;" allowResize="true"
        url="<%=request.getContextPath()%>/admin/queryAllGroups.action"  idField="id"  
    >
...
function onSaveUser(){
    ...
    /*$.ajax({
        url: "<%=request.getContextPath()%>/admin/addUser.action",
        type: "post",
    ...
    var url='<%=request.getContextPath()%>/admin/addUser.action';
    Web.util.request(url,'',{ json: json,groups:groups },function(){
    	 mini.alert("保存成功，初始密码为帐号名。");
            mini.get("id_saveuser").disable();
    });
}
